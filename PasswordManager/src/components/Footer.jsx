...
<footer className="rounded-lg shadow m-4 dark:bg-gray-800 max-w-[95.5vw]">
    <div className="h-100 mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://github.com/DebjitPal9" className="hover:underline">PassMan™</a>. All Rights Reserved.
    </span>
